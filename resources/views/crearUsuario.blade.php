...
@section('contenido')
            <div class="md:w-4/12 bg-white p-6 rounded-lg drop-shadow-2xl mt-1.5">
                ...
                <form action="crud.store" method="POST" class="pt-6"">
                    @csrf
                        ...
                        <div class="mb-5">
                            ...
                            <input type="direccion" id="direccion" name="password" class="border p-1 w-full rounded-lg mb-10">
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="number" id="telefono" name="password" class="border p-1 w-full rounded-lg mb-10">
                        </div>
